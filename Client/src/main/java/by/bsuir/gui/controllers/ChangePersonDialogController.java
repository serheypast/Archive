...
public class ChangePersonDialogController {
    ...
    private void initialize(){
        ...
        tFieldFirstName.setText(personDao.getFirstName());
        tFieldFirstName.setDisable(true);
        tFieldLastName.setText(personDao.getLastName());
        tFieldLastName.setDisable(true);
        tFieldCompany.setText(personDao.getInfoAboutWork().getNameOfCompany());
        tFieldEmail.setText(personDao.getEmail());
        tFieldPhoneNumber.setText(personDao.getNumberPhone());
        tFieldPosition.setText(personDao.getInfoAboutWork().getNameOfPosition());
        tFieldSalary.setText(String.valueOf(personDao.getInfoAboutWork().getSalary()));
        tFieldExperience.setText(String.valueOf(personDao.getInfoAboutWork().getExperience()));
    }
    ...
    private void setBtnOkAction(){
        ...
        if(firstName.equals("")||lastName.equals("")||email.equals("")||phoneNumber.equals("")){
            ...
            request.setNameOfRequest(ERequest.CHANGE_PERSON);
            ...
            if(response.getNameOfResponse() == EResponse.REQUEST_COMPLETE){
                MainWindowController.currentPerson.setEmail(email);
                MainWindowController.currentPerson.setNumberPhone(phoneNumber);
                MainWindowController.currentPerson.getInfoAboutWork().setNameOfCompany(company);
                MainWindowController.currentPerson.getInfoAboutWork().setNameOfPosition(position);
                MainWindowController.currentPerson.getInfoAboutWork().setSalary(Integer.parseInt(salary));
                MainWindowController.currentPerson.getInfoAboutWork().setExperience(Integer.parseInt(experience));
                ...
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setHeaderText("ERROR");
                String s ="Person has'n been changed";
                alert.setContentText(s);
                alert.show();
            }
